...
- [EU Compliance MCP (offline)](https://github.com/matematicsolutions/mcp-eu-compliance) - **[🇪🇺 EU]** Offline MCP corpus of EU law (GDPR, AI Act, DORA, NIS2, eIDAS 2.0, CRA): full text in a local SQLite FTS5 index, verbatim retrieval with no LLM in the loop, runs air-gapped - a local-first counterpart to hosted EU-law gateways for privileged or data-sensitive workflows. MIT.
